...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for ubiq/rosetta-ubiq 
...
execute() {
  ...
  docker tag "rosetta-ubiq:${TAG}" "rosetta-ubiq:latest"
  log_info "loaded rosetta-ubiq:${TAG} and tagged as rosetta-ubiq:latest"
  rm -rf "${tmpdir}"
